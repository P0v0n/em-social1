...
export default function CollectionPage() {
    ...
    return (
        <div className="p-6 bg-gray-950 text-white min-h-screen relative">
            <DottedBackground />
                    ...
                    <thead>
                        <tr className="bg-gray-900">
                            {FIELDS_TO_SHOW.map((col) => (
                                <th
                                    key={col}
                                    className="px-4 py-2 text-left font-medium uppercase text-xs border border-gray-700 cursor-pointer select-none"
